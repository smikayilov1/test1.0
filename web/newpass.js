(function () {
    ...
    var eightPlus = document.getElementById("length");
    ...
    var verifyPasswordSubmitBtn = document.getElementById(
    ...
    verifyPasswordForm.addEventListener("submit", function (evt) {
        ...
        setTimeout(function () {
            ...
            window.location.href = "/FirstApp/ChangedPass?changedpass="+i;
        }, 400);
        evt.preventDefault();
    });
