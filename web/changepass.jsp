<%-- 
    Document   : changepass
    Created on : Feb 24, 2021, 5:54:51 PM
    Author     : smikayilov
--%>
...
<html>
    ...
    <body>
        ...
        <!--            <form action="/FirstApp/ChangedPass" method="post">
                        <input type="password" name="changedpass" placeholder="New Password"/></br></br>
                        <input type="submit">
                    </form>-->
        <div class="ripple">
            <div></div>
    ...
    Based on an awesome idea from Aerotwist.
    http://aerotwist.com/blog/better-password-form-fields/
        ...
        <div id="form-container">
            ...
            <form id="verify-new-password">
                ...
                <label for="verify-password">Verify a password</label>
                <input
                    
                    placeholder="Enter your password again"
                    type="password"
                    id="verify-password"
                    name="password-to-verify"
                    style="
            ...
            <form id="new-password" class="visible" >
                ...
                <ul>
                    ...
                    <li id="punctuation">Contains punctuation.</li>
                </ul>
